...
from .views import (
    ...
    TermListView,
    TermUpdateView,
    AcademicMonthCreateView,
    AcademicMonthDeleteView,
    AcademicMonthListView,
    AcademicMonthUpdateView,
)
...
urlpatterns = [
    ...
    path("month/list/", AcademicMonthListView.as_view(), name="months"),
    path("month/create/", AcademicMonthCreateView.as_view(), name="month-create"),
    path(
        "month/<int:pk>/update/",
        AcademicMonthUpdateView.as_view(),
        name="month-update",
    ),
    path(
        "month/<int:pk>/delete/",
        AcademicMonthDeleteView.as_view(),
        name="month-delete",
    ),
]
